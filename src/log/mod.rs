...
pub macro trace {
  ($($args:tt)*) => {
    log::trace!(target: $crate::stdext::function_name!(), $($args)*)
  }
}
...
pub macro debug {
  ($($args:tt)*) => {
    log::debug!(target: $crate::stdext::function_name!(), $($args)*)
  }
}
...
pub macro info {
  ($($args:tt)*) => {
    log::info!(target: $crate::stdext::function_name!(), $($args)*)
  }
}
...
pub macro warn {
  ($($args:tt)*) => {
    log::warn!(target: $crate::stdext::function_name!(), $($args)*)
  }
}
...
pub macro error {
  ($($args:tt)*) => {
    log::error!(target: $crate::stdext::function_name!(), $($args)*)
  }
}
